...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        ms = (end - start).seconds
        OUTPUT_STR = """{img_size}
**Possible Related Search**: [RESULT](http://www.google.com/search?q=Dick&sa=X&ved=2ahUKEwiLyfLkppLnAhVRAp0JHalFBVQQvQ4oBHoECAcQKw)
 
More Info: Open this [link](https://www.github.com/leobrownlee/FRIDAY) in {ms} seconds""".format(**locals())
    await event.edit(OUTPUT_STR, parse_mode="HTML", link_preview=False)
